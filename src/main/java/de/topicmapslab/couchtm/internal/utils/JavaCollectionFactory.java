...
import de.topicmapslab.couchtm.internal.api.ICollectionFactory;
...
final class JavaCollectionFactory implements ICollectionFactory {
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createIntObjectMap()
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createIntObjectMap(int)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createMap(int)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createMap()
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createMap(java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createIdentityMap()
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createIdentityMap(int)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createSet(int)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createSet()
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createSet(java.util.Set)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createIdentitySet()
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createIdentitySet(int)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createIdentitySet(java.util.Set)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createList()
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createList(java.util.Collection)
     */
    ...
    /* (non-Javadoc)
     * @see de.topicmapslab.couchtm.internal.api.ICollectionFactory#createList(int)
     */
