...
/**
 * {@link Variant} interface for CouchTM.
 * 
 * @author Hans-Henning Koch (phi04bib[at]studserv.uni-leipzig.de)
 */
public interface IVariant extends Variant, IConstruct, IReifiable{
	
	/**
	 * Returns the <tt>IVariant</tt> this variant was merged in.
	 * 
